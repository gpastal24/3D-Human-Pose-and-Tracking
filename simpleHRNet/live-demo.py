...
def main(camera_id, filename, hrnet_m, hrnet_c, hrnet_j, hrnet_weights, hrnet_joints_set, image_resolution,
    ...
    while True:
        ...
        pts = model._predict_single(frame)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--filename", "-f", help="open the specified video (overrides the --camera_id option)",type=str, )
    ...
    parser.add_argument("--hrnet_weights", "-w", help="hrnet parameters - path to the pretrained weights",
                        type=str,default='/home/gpastal/code/simpleHRNet/weights/pose_hrnet_w48_256x192.pth')
